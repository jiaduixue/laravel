(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            ...
            +'<td width="3"><td><input type="text" id="HexColor" readonly size="7" style="border:inset 1px;font-family:Arial;" value="#000000"></td>'
			+'<td width="95" class="text-right"><a href="javascript:void(0)" class="ico-cancel-circle2" id="_cclose"></a></td></tr></table></td></table>'
	...
	$(document).bind("click",function(e){
		var target  = $(e.target);
		if(target.closest("#colorpanel").length == 0){
			$("#colorpanel").hide();
		}
	});
	//监视输入框内色值
	$(".color-code").on("blur",function(e){
		var strColor=$(this).val();
		$(".color-icon").css("background",strColor);
		if($(".color-icon").attr("style")==""){
			$(this).val("");
		}
	});
